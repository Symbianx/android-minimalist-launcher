...
class SettingsScreenTest {
    ...
    @Test
    fun settingsScreen_displays_autoLaunchSection() =
        runTest {
    ...
    @Test
    fun settingsScreen_displays_quickActionSection() =
        runTest {
            // Given settings screen with default settings
            val settings = LauncherSettings()
    ...
    @Test
    fun settingsScreen_displays_batteryIndicatorSection() =
        runTest {
            // Given settings screen with default settings
            val settings = LauncherSettings()
    ...
    @Test
    fun settingsScreen_displays_resetSection() =
        runTest {
            // Given settings screen with default settings
            val settings = LauncherSettings()
    ...
    @Test
    fun settingsScreen_showsLoading_whenStateIsLoading() =
        runTest {
            // Given loading state
            composeTestRule.setContent {
                MinimalistLauncherTheme {
    ...
    @Test
    fun settingsScreen_showsAllSections_whenStateIsLoaded() =
        runTest {
