...
object AnimationUtil {
     ...
     */
    fun <T> defaultSpring(): AnimationSpec<T> =
        spring(
     ...
     */
    fun <T> defaultTween(durationMs: Int = 300): AnimationSpec<T> =
        tween(
     ...
     */
    @Composable
    fun rememberFloatAnimatable(initialValue: Float = 0f): Animatable<Float, *> = remember { Animatable(initialValue) }
}
