...
class FavoritesDataSourceImpl(
    ...
    override suspend fun saveFavorites(favorites: List<FavoriteApp>) =
    ...
    override suspend fun loadFavorites(): List<FavoriteApp> =
        withContext(Dispatchers.IO) {
    ...
    private fun FavoriteApp.toSerializable() =
        SerializableFavoriteApp(
    ...
    private fun SerializableFavoriteApp.toDomain() =
        FavoriteApp(
            packageName = packageName,
            label = label,
            addedTimestamp = addedTimestamp,
